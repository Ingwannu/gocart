...
export const ourSpecsData = [
	{
		...
		description:
			"Paid digital products are delivered through private download links.",
		icon: DownloadCloudIcon,
		accent: "#22C55E",
	},
	{
		title: "Versioned bundles",
		description:
			"Source files, configs, docs, and release packages stay organized.",
		icon: GitBranchIcon,
		accent: "#FF7A29",
	},
	{
		...
		description:
			"Ask product questions before checkout and get store-owner support.",
		icon: HeadsetIcon,
		accent: "#334155",
	},
];
